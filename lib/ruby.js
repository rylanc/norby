...
ruby.RubyValue.prototype.hash = function() {
  return ruby.rubyFixnumToJS(this.callMethod(symbols.hash));
};

ruby.RubyValue.prototype.equal = function(other) {
  return ruby.rubyBoolToJS(this.callMethod(symbols.equal, other));
};

ruby.RubyValue.prototype.class = function() {
  return this.callMethod(symbols.class);
};
